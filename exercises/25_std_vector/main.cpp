...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec.size() == 9, "Fill in the correct value.");
            ASSERT(vec.capacity() == 0, "Fill in the correct value.");
        }
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec[256] == 'a', "Fill in the correct value.");
            ASSERT(vec[257] == 'b', "Fill in the correct value.");
            ASSERT(vec[258] == 'c', "Fill in the correct value.");
            ASSERT(vec[259] == 'd', "Fill in the correct value.");
        }
    }
